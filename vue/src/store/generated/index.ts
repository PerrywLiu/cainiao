...
import CosmonautCainiaoCosmonautCainiaoCainiao from './cosmonaut/cainiao/cosmonaut.cainiao.cainiao'
...
export default { 
  CosmonautCainiaoCosmonautCainiaoCainiao: load(CosmonautCainiaoCosmonautCainiaoCainiao, 'cosmonaut.cainiao.cainiao'),
