...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"cosmonaut", "cainiao", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Orders_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"cosmonaut", "cainiao", "orders", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_OrdersAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"cosmonaut", "cainiao", "orders"}, "", runtime.AssumeColonVerbOpt(true)))
)
